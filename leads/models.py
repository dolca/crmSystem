...
from listings.selectors import TIP_PROPRIETATE, TIP_APARTAMENT, DESTINATIE_AP, ETAJ_AP, STADIU_CONSTRUCTIE, MOBILIER, CONFORT, \
    COMPARTIMENTARE_AP, ORIENTARE, TIP_CASA, TIP_TEREN, DESTINATIE_TEREN, CLASIFICARE_TEREN, UNITATE_SUPRAFATA, \
    DESCHIDERE, TIP_IMOBIL_SPATIU, DESTINATIE_SP_COMERCIAL, TRAFIC_PIETONAL, ETAJ_SPATIU, COMPARTIMENTARE_SPATIU, \
    CLASA_SP_BIROURI, TIP_SP_INDUSTRIAL, DESTINATIE_SP_INDUSTRIAL, ETAJ_SP_INDUSTRIAL


class Lead(Model):
    status = CharField(max_length=10, choices=STATUS, default='Activă', verbose_name='Status cerere⋆')
    property_type = CharField(max_length=18, choices=TIP_PROPRIETATE, default='apartment', verbose_name='Tip proprietate⋆')
    transaction_type = CharField(max_length=11, choices=TIP_TRANZACTIE, verbose_name='Tip tranzacție⋆')
    ...
    payment_method = CharField(max_length=20, choices=MODALITATE_PLATA, null=True, blank=True, verbose_name='Modalitate plată', )

    urgency = CharField(max_length=8, choices=URGENTA, default='Normal', verbose_name='Urgență')
    other_details = TextField(max_length=255, null=True, blank=True, verbose_name='Alte detalii')

    labels = CharField(max_length=20, choices=ETICHETA, null=True, blank=True, verbose_name='Etichete')
...
class ApartmentLead(Lead):
    ...
    destination = CharField(max_length=15, choices=DESTINATIE_AP, verbose_name='Destinație⋆')
    ...
    floor = CharField(max_length=18, choices=ETAJ_AP, null=True, blank=True, verbose_name='Etaj')
    excluded_ground_floor = BooleanField(default=False, verbose_name='Exclus parter')
    excluding_top_floor = BooleanField(default=False, verbose_name='Exclus ultimul etaj')
    ...
    ap_compart = CharField(max_length=15, choices=COMPARTIMENTARE_AP, null=True, blank=True, verbose_name='Compartimentare')
    orientation = CharField(max_length=10, choices=ORIENTARE, null=True, blank=True, verbose_name='Orientare')
    interior_finishes = CharField(max_length=18, choices=FINISAJE, null=True, blank=True, verbose_name='Stare interior')
...
class TerrainLead(Lead):
    ...
    destination = CharField(max_length=17, choices=DESTINATIE_TEREN, verbose_name='Destinație⋆')
    ...
    unit = CharField(max_length=12, choices=UNITATE_SUPRAFATA, null=True, blank=True, verbose_name='Unitate suprafață')
...
class CommercialSpaceLead(Lead):
    ...
    nr_bathrooms = IntegerField(null=True, blank=True, verbose_name='Număr băi')
    floor = CharField(max_length=18, choices=ETAJ_SPATIU, null=True, blank=True, verbose_name='Etaj')
    nr_floors = IntegerField(null=True, blank=True, verbose_name='Număr etaje')
