...
class Lead(Model):
    ...
    label = CharField(choices=ETICHETA, null=True, blank=True, verbose_name='Etichetă')
...
class TerrainLead(Lead):
    ...
    classification = CharField(choices=CLASIFICARE_TEREN, null=True, blank=True, verbose_name='Clasificare')
