    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_status', models.CharField(choices=[('Activă', 'Activă'), ('Incompletă', 'Incompletă'), ('Retrasă', 'Retrasă'), ('Pierdută', 'Pierdută')], default='Incompletă', verbose_name='Status proprietate')),
                ('property_type', models.CharField(choices=[('Apartament', 'Apartament'), ('Casă', 'Casă'), ('Teren', 'Teren'), ('Spațiu comercial', 'Spațiu comercial'), ('Spațiu de birouri', 'Spațiu de birouri'), ('Spațiu industrial', 'Spațiu industrial')], default='Apartament', verbose_name='Tip proprietate')),
                ...
                ('images', models.ImageField(blank=True, null=True, upload_to='media/listings/', verbose_name='Imagini')),
